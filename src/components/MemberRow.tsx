      ...
      <li className="card fade-in-up p-4">
        ...
        >
          <div className="flex flex-col gap-2 sm:flex-row sm:items-center">
            <Avatar name={member.name} avatarPath={member.avatarPath} colors={member.colors} size={36} />
            <input
              name="name"
              type="text"
          ...
          <div className="flex items-center gap-2.5">
            ...
            <ColorPicker withMarker selected={member.colors} />
          </div>
        </form>
        {error && (
  ...
  return (
    <li className="card fade-in-up flex items-center justify-between gap-3 p-3">
      <div className="flex min-w-0 items-center gap-3">
        <Avatar name={member.name} avatarPath={member.avatarPath} colors={member.colors} size={40} dimmed={!member.active} />
